...
public class ComplaintController {
    ...
    public Map<String, Object> page(
        ...
        return complaintService.getByPage(ownerId, status, pageNum, pageSize);
    }
    ...
    @PostMapping("/add")
    public Map<String, Object> add(@RequestBody Complaint complaint) {
        Map<String, Object> result = new HashMap<>();
        try {
            int rows = complaintService.add(complaint);
    ...
    public Map<String, Object> update(@RequestBody Complaint complaint) {
        Map<String, Object> result = new HashMap<>();
        try {
            int rows = complaintService.update(complaint);
            result.put("code", rows > 0 ? 0 : 1);
    ...
    public Map<String, Object> delete(@PathVariable Integer id) {
        Map<String, Object> result = new HashMap<>();
        try {
            int rows = complaintService.delete(id);
            result.put("code", rows > 0 ? 0 : 1);
